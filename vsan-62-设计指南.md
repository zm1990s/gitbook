...
![VSAN 文件系统开销对比](http://img0.ph.126.net/J1iwZIc_oa5kvu823zJ8nQ==/6631712079514947288.png)
...
SATADOM 相比 SD 卡和 U 盘有更高的寿命和性能，所以日志可以保存在这些设备，但是对设备有些要求：容量>=16G，寿命： </span>512-1024 TBW _(VSAN6.1及之前) _/ 384 TBW_（VSAN 6.2）
